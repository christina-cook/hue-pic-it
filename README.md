...
Our main focus was user login and authorization, with a fairly simple user interface and functionality of the site. We learned
>>>>>>>>> ADD LEARNING/SUCCESS/FAILURES?
...
No future development is planned at this time, but if time allowed or for future iterations we might address:
- 
>>>>>>>>>> ADD FUTURE ITERATIONS/ISSUES UNRESOLVED
...
_________________________________ DELETE AFTER DEPLOY:
